...
export function SlideRenderer({ slide, progress, onReplay }: SlideRendererProps) {
  switch (slide.type) {
    ...
    case 'mileage':
      return <MileageSlide slide={slide} />;
    case 'archetype':
      return <ArchetypeSlide slide={slide} />;
    case 'reel':
      return <ReelSlide slide={slide} progress={progress} />;
    case 'award':
      return <AwardSlide slide={slide} />;
    case 'letter':
      return <LetterSlide slide={slide} onReplay={onReplay} />;
  }
}
